...
export const siteConfig: SiteConfig = {
	...
	siteStartDate: "2026-04-24", // 站点开始运行日期，用于站点统计组件计算运行天数
...
export const musicPlayerConfig: MusicPlayerConfig = {
	...
	id: "8434192369", // https://y.music.163.com/m/playlist?id=8434192369&userid=1389857309&creatorId=1389857309
